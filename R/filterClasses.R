...
setGeneric("arOrder", def = function(object, ...){ standardGeneric("arOrder") } )
setGeneric("maOrder", def = function(object, ...){ standardGeneric("maOrder") } )
setGeneric("arCoef", def = function(object, ...){ standardGeneric("arCoef") } )
setGeneric("maCoef", def = function(object, ...){ standardGeneric("maCoef") } )
setGeneric("arPolyCoef", def = function(object, ...){ standardGeneric("arPolyCoef") } )
setGeneric("maPolyCoef", def = function(object, ...){ standardGeneric("maPolyCoef") } )
...
setMethod("arOrder", "VirtualArmaFilter", function(object) filterOrder(object@ar) )
setMethod("maOrder", "VirtualArmaFilter", function(object) filterOrder(object@ma) )

setMethod("arCoef", "VirtualArmaFilter",
          function(object, ...) filterCoef(object@ar, ...) )
setMethod("maCoef", "VirtualArmaFilter",
          function(object, ...) filterCoef(object@ma, ...) )

setMethod("arPolyCoef", "VirtualArmaFilter",
          function(object) filterPolyCoef(object@ar, lag_0 = FALSE) )
setMethod("maPolyCoef", "VirtualArmaFilter",
          function(object) filterPolyCoef(object@ma, lag_0 = FALSE) )
