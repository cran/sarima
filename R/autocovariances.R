...
##
acfIidTest <- function(acf, n, npar = 0, nlags = npar + 1, method, interval = 0.95){
    maxlag <- max(nlags)
    usedLags <- 1:maxlag
    switch(method,
           "LjungBox" = {
...
.wn_test_iid <- function(acr, x, nlags, method, n = length(x), interval = 0.95){
